...
// declaring checkinput here so it can later be used in the checkPassword function
var checkinput = document.getElementById("checkerinput").value;

let passwords = []; //declaring passwords so it can later be filled
...
.then(data => {passwords = data.passwords;}) //fills the passwords variable with passwords from the database.json
...
function checkPassword() {
    ...
    if (passwords.includes(checkinput)) {
